...
import {assignAll, bindAll, createAction, createReducer, batch, disbatch} from 'redux-act';
...
describe('README', function () {
  ...
  it('should validate createReducer API 2', function () {
    ...
    handlers[increment.toString()] = (state)=> state + 1;
    ...
    delete(handlers[increment.toString()]);
